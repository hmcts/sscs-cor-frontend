...
function verifyStatusHeader() {
  ...
  I.see(content.en.statusTab.tabHeader, '.govuk-tabs__list-item govuk-tabs__list-item--selected');
...
function verifyWelshStatusHeader() {
  ...
  I.seeElement('.navigation-tabs');
  I.see(content.cy.statusTab.tabHeader, '.govuk-tabs__list-item govuk-tabs__list-item--selected');
