...
describe.skip('Additional Evidence', () => {
  ...
  it('navigates to additional evidence page and shows options', async () => {
    ...
    expect(header).to.equal(i18n.en.additionalEvidence.evidenceOptions.header);
  ...
  it('shows an error if no file to upload and no description', async () => {
    ...
    expect(await additionalEvidenceUploadPage.getElementText('div.govuk-error-summary')).contain(i18n.en.additionalEvidence.evidenceUpload.error.emptyDescription);
    expect(await additionalEvidenceUploadPage.getElementText('div.govuk-error-summary')).contain(i18n.en.additionalEvidence.evidenceUpload.error.noFilesUploaded);
  });
  ...
  it('uploads a file and shows file list', async () => {
    ...
    expect(await additionalEvidenceUploadPage.getHeading()).to.equal(i18n.en.additionalEvidence.evidenceUpload.header);
