...
describe('Appellant - Manage your appeal app @mya @nightly', () => {
  ...
  describe('Status page', () => {
    it('should display navigation tabs and Status tab should be active', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.en.statusTab.tabHeader);
    });
  ...
  describe('Hearing page', () => {
    it('Navigate to hearing tab', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.en.hearingTab.tabHeader);
    });
  ...
  describe('Audio/video Evidence page', () => {
    it('Navigate to Audio/Video Evidence tab', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.en.avEvidenceTab.tabHeader);
