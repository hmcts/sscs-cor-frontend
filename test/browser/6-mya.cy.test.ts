...
describe('Welsh Manage your appeal app @mya @nightly', () => {
  ...
  describe('CY:Status page', () => {
    it('should display navigation tabs and Status tab should be active', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.cy.statusTab.tabHeader);
    });
  ...
  describe('CY - Hearing page', () => {
    it('CY - Navigate to hearing tab', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.cy.hearingTab.tabHeader);
    });
    /* PA11Y */
  ...
  describe('CY - Audio/video Evidence page', () => {
    it('CY - Navigate to Audio/Video Evidence tab', async() => {
      ...
      expect(await statusPage.getElementText('.govuk-tabs__list-item govuk-tabs__list-item--selected')).contain(content.cy.avEvidenceTab.tabHeader);
