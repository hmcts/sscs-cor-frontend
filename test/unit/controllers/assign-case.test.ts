  ...
  describe('postIndex', () => {
    ...
    describe('for missing postcode', () => {
      ...
      it('redirects to task-list', async () => {
        ...
        expect(res.render).to.have.been.calledOnce.calledWith('assign-case/index.html', { error: i18n.en.assignCase.errors.noPostcode });
      });
    });
    ...
    describe('for invalid postcode', () => {
      ...
      it('redirects to task-list', async () => {
        ...
        expect(res.render).to.have.been.calledOnce.calledWith('assign-case/index.html', { error: i18n.en.assignCase.errors.invalidPostcode });
      });
    });
  });
});
