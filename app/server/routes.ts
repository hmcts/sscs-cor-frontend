...
import { setupAdditionalInfoController } from './controllers/additional-info';
...
const evidenceOptionsController = setupAdditionalInfoController({ prereqMiddleware: ensureAuthenticated });
