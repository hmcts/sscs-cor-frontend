...
function getIndex(req: Request, res: Response) {
  ...
  return res.render('hearing-why/index.html', { submitted: appellantRejected, responseDate, ft_welsh: req.session.featureToggles.ft_welsh });
}
...
function postIndex(hearingService) {
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    if (validationMessage) return res.render('hearing-why/index.html', { error: validationMessage, ft_welsh: req.session.featureToggles.ft_welsh });
    ...
    try {
      ...
      return res.render('hearing-why/index.html', { submitted: true, hearing: req.session.hearing, responseDate, ft_welsh: req.session.featureToggles.ft_welsh });
    } catch (error) {
