...
function setupSupportEvidenceController(deps: any): Router {
  ...
  res.render('help-guides/support-evidence.html', { req, ft_welsh: req.session.featureToggles.ft_welsh }));
  return router;
}
...
function setupSupportHearingExpensesController(deps: any): Router {
  ...
  res.render('help-guides/support-hearing-expenses.html', { req, ft_welsh: req.session.featureToggles.ft_welsh }));
  return router;
}
...
function setupSupportHearingController(deps: any): Router {
  ...
  res.render('help-guides/support-hearing.html', { req, ft_welsh: req.session.featureToggles.ft_welsh }));
  return router;
}
...
function setupSupportRepresentativesController(deps: any): Router {
  ...
  res.render('help-guides/support-representatives.html', { req, ft_welsh: req.session.featureToggles.ft_welsh }));
  return router;
}
...
function setupSupportWithdrawAppealController(deps: any): Router {
  ...
  res.render('help-guides/support-withdraw-appeal.html', { req, ft_welsh: req.session.featureToggles.ft_welsh }));
  return router;
}
